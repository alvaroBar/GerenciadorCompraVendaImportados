...
class ItemEstoque(db.Model):
    ...
    def to_dict(self):
        # ... (sem mudanças, apenas para encurtar)
...
class ContaAPagar(db.Model):
    ...
    # Link para a transação que pagou esta conta
    ...
    def to_dict(self):
        return {
            ...
            'valor_brl': self.valor_brl,
            'data_vencimento': self.data_vencimento.isoformat().split('T')[0],  # Formata como AAAA-MM-DD
            'status': self.status,
